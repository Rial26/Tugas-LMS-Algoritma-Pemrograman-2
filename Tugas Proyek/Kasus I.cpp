...
int main (){
	garis();
	cout<<"\t\Program untuk menghitung Nilai akhir Mahasiswa Program Studi Teknik Informatika" << endl;
	garis();
	
	cout<<"Input Jumlah Mahasiswa : ";
	cin>>jml_mhs;
	string Mahasiswa [jml_mhs][6];
	...
	label:
		// search data
		cout<<"Masukkan Stambuk Yang Ingin Dicari : ";
		cin>> Str2;
		for(x = 0; x < jml_mhs; x++){
			Str1 = Mahasiswa[x][0];
